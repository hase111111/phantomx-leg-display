...
if __name__ == "__main__":
    # ロボットのステータスをprintする．
    calc = HexapodLegRangeCalculator()
    print("COXA_LENGTH : " + str(calc.COXA_LENGTH))
    print("FEMUR_LENGTH : " + str(calc.FEMUR_LENGTH))
    print("TIBIA_LENGTH : " + str(calc.TIBIA_LENGTH))

    print("THETA1_MIN : " + str(math.degrees(calc.THETA1_MIN)))
    print("THETA1_MAX : " + str(math.degrees(calc.THETA1_MAX)))
    print("THETA2_MIN : " + str(math.degrees(calc.THETA2_MIN)))
    print("THETA2_MAX : " + str(math.degrees(calc.THETA2_MAX)))
    print("THETA3_MIN : " + str(math.degrees(calc.THETA3_MIN)))
    print("THETA3_MAX : " + str(math.degrees(calc.THETA3_MAX)))

    print("MIN_RADIUS : " + str(calc.get_approximate_min_leg_raudus()))
    ...
    res = calc.calc_inverse_kinematics_xz(x, z)

    if res[0]:
        print("joint_pos : " + str(res[1]))
        print("angle : " + str(res[2]))
    else:
        print("cannot reach")
